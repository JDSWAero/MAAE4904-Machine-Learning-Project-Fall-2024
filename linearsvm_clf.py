...
class LinearSVMCLF: # Change to name of model as needed e.g. SupportVectorMachineCLF
    '''
    ModelName Classifier for Images
    '''
    def __init__(self,train_dataset:tuple,model_dir:str,model_name:str='LinearSVMCLF'):
        '''
        ...
        self.base_model = LinearSVC(C=1.0, random_state=42, max_iter=200) # Read training progress from command line
...
class EnsembleLinearSVMCLF:
    def __init__(self,n_estimators:int,train_dataset:tuple,model_dir:str,model_name:str='EnsembleModelNameCLF'):
        ...
        self.base_model = LinearSVC(kernel='linear',C=1.0, random_state=42) # Read training progress from command line
